  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-red-600 text-white py-3 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center">
            <span className="text-xs font-medium tracking-wider uppercase">ADVERTORIAL</span>
          </div>
          <div className="text-center mt-2">
            <h1 className="text-3xl font-bold">g1 PETS</h1>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        {/* Main Title */}
        <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-center text-gray-900 mb-8 leading-tight">
          Campanha pela proteção animal: Empresa distribui tags localizadores grátis para cães e gatos
        </h1>

        {/* Subtitle/Lead */}
        <p className="text-gray-700 text-lg md:text-xl leading-relaxed mb-6 max-w-5xl mx-auto">
