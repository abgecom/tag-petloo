...
export default function PricingSectionV4() {
  ...
  const kitItems = [
    ...
    { name: "Tag de rastreamento 4.0", originalPrice: "189,00", finalPrice: "149,87" },
            ...
            <div className="space-y-3 mb-6">
              <button
                onClick={() => {
                  ...
                  window.location.href = `/checkout?product=lootag-kit&price=149.87&petSize=${selectedPetSize}&deviceType=ios`
                }}
                className="w-full border-2 border-gray-200 hover:border-petloo-purple rounded-xl p-4 text-left transition-all hover:shadow-md"
              >
                <div className="flex items-center justify-between">
              ...
              <button
                onClick={() => {
                  setShowDeviceModal(false)
                  window.location.href = `/checkout?product=lootag-kit&price=149.87&petSize=${selectedPetSize}&deviceType=android`
                }}
                className="w-full border-2 border-gray-200 hover:border-petloo-purple rounded-xl p-4 text-left transition-all hover:shadow-md"
              >
                <div className="flex items-center justify-between">
