...
export default function PixPaymentClient({ orderId, amount }: { orderId: string; amount: number }) {
  ...
  // ============================================
  // ALTERAÇÃO PRINCIPAL: Redirecionar para upsell-tag
  // em vez de /obrigado ao clicar "Já efetuei o pagamento"
  // ============================================
  const handlePaymentDone = () => {
    router.push(`/upsell-tag?orderId=${orderId}`)
  }
    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      ...
      <div className="max-w-md mx-auto">
          ...
          <div className="bg-blue-50 p-4 rounded-lg mb-6">
            ...
            <ol className="text-sm text-blue-700 space-y-2">
              ...
              <li className="flex items-start">
                ...
                <span>Clique em "Já efetuei o pagamento" abaixo</span>
              </li>
            </ol>
          </div>
        ...
        <div className="space-y-3 mb-6">
          {/* ============================================
              ALTERAÇÃO: Botão agora redireciona para /upsell-tag
              em vez de /obrigado diretamente
              ============================================ */}
          <Button
